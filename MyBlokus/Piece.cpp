        ...
        void Piece::draw(sf::RenderWindow& window,
            ...
            for (int i = 0; i < 6; i++) {
                for (int j = 0; j < 6; j++) {
                    ...
                    if (board.getProvisionalBoard(i,j) == 1) {
